export default function PlainData() {
	return (
		<div className="bg-gray-200 p-12 pt-4">
			...
			<div className="  flex flex-row justify-center items-center gap-8 lg:gap-0 flex-wrap lg:items-start">
				<div className="stat lg:w-1/2 xl:w-1/3   min-w-1/3 min-h-1/3">
					...
					<h5 className="ml-4 text-xl font-semibold" id="related-skills-">
						related skills:
					</h5>
				...
				<div className="stat lg:w-1/2 xl:w-1/3   min-w-1/3 min-h-1/3">
					...
					<p className="text-lg">
						...
						Luck stat lg:w-1/2 xl:w-1/3 is used up. Luck is always restored at
				...
				<div className="stat lg:w-1/2 xl:w-1/3   min-w-1/3 min-h-1/3">
					...
					<h5 className="ml-4 text-xl font-semibold" id="related-stats-">
						related stats:
					</h5>
					<ul className="mt-2 list-disc">
						<li>
				...
				<div className="stat lg:w-1/2 xl:w-1/3   min-w-1/3 min-h-1/3">
					...
					<p className="text-lg">
						This stat lg:w-1/2 xl:w-1/3 represents how well you relate to other
						living things - a measure of charisma and sympathetic emotions. In a
						world of alienated, future-shocked survivors, the ability to be
