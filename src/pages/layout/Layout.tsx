...
export default function Layout() {
	return (
		<div className="flex flex-col flex-nowrap h-[100vh]">
			...
			<nav className="fixed bottom-0 border-t-[1px] border-terminal-400 shadow-inner shadow-terminal-600 w-full h-24 p-4 bg-black text-terminal-400 font-press text-sm">
				<p className="text-xs">
